...
/*
//This is for writing to output window from form application during debug.
//Lookup up System::Diagnostics::Debug
#using <System.dll>
...
void Test1::CreateTestMatrix()
{
	...
	//MessageBox::Show("This test is confirmed!");

	EigenClass^ ec = gcnew EigenClass(A);
	EigenClass^ eb = gcnew EigenClass(*B);

	ec->Delete();
	eb->Delete();
}

void Test1::ArmadilloTest()
{
	mat A(2, 3);
	...
	//double a = 1.23;
	//System::Diagnostics::Debug::WriteLine(String::Format("Hello {0}", a.ToString()));
